...
public class Weapon : PartWeightManager
{
	...
	public List<WeightClasses> weaponWeight;
	...
	public Weapon(string Name,WeaponType Type,int MinDamage, int MaxDamage,int Range,float Accuracy,int APCost,int PartWeight, int ID)
	{
		weaponName = Name;
		weaponType = Type;
	...
	/// <param name="ID">ID number of weapon for sorting.</param>
	public Weapon(string Name,WeaponType Type,int MinDamage, int MaxDamage,int Range,float Accuracy,int APCost,int PartWeight, int Splash, int ID)
	{
		weaponName = Name;
		weaponType = Type;
		weaponMinDamage = MinDamage;
	...
	/// <param name="ID">ID number of weapon for sorting.</param>
	public Weapon(string Name,WeaponType Type,int MinDamage, int MaxDamage,int Range,float Accuracy,int APCost,int PartWeight, int Splash, int Scatter, int ID)
	{
		weaponName = Name;
		weaponType = Type;
		weaponMinDamage = MinDamage;		
